...
from ThorLabsDriver import PowerMeter
...
def open_powermeter(serialnumber):
    ...
    Returns: ThorLabsMotors.PowerMeter.TLPM object
    """
    ...
    for i in range(0, deviceCount.value):
        ...
        resourceName = powermeter.getRsrcName(
            i, resourceName=ctypes.create_string_buffer(1024)
        )[1]
...
def measure(powermeter):
    powermeter.setPowerUnit(pm_settings.powerUnit)
    powermeter.setWavelength(pm_settings.wavelength)
