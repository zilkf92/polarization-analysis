...
TLPM_PID_PM101_DFU = (
    0x8076  # PM101 on USB with DFU interface enabled (Interface 0 TMC, Interface 1 DFU)
)
TLPM_PID_PM102_DFU = (
    0x8077  # PM102 on USB with DFU interface enabled (Interface 0 TMC, Interface 1 DFU)
)
TLPM_PID_PM103_DFU = (
    0x807A  # PM103 on USB with DFU interface enabled (Interface 0 TMC, Interface 1 DFU)
)
...
PM100USB_FIND_PATTERN = (
    "USB?*INSTR{VI_ATTR_MANF_ID==0x1313 && VI_ATTR_MODEL_CODE==0x8072}"
)
...
PM101_FIND_PATTERN = (
    "USB?*INSTR{VI_ATTR_MANF_ID==0x1313 && (VI_ATTR_MODEL_CODE==0x8076)}"
)
PM102_FIND_PATTERN = (
    "USB?*INSTR{VI_ATTR_MANF_ID==0x1313 && (VI_ATTR_MODEL_CODE==0x8077)}"
)
PM103_FIND_PATTERN = "USB?*INSTR{VI_ATTR_MANF_ID==0x1313 && VI_ATTR_MODEL_CODE==0x807A}"
PMTest_FIND_PATTERN = (
    "USB?*INSTR{VI_ATTR_MANF_ID==0x1313 && VI_ATTR_MODEL_CODE==0x807F}"
)
PM100_FIND_PATTERN = "USB?*::0x1313::0x807?::?*::INSTR"
PMxxx_FIND_PATTERN = (
    "USB?*INSTR{VI_ATTR_MANF_ID==0x1313 && (VI_ATTR_MODEL_CODE==0x8070 || VI_ATTR_MODEL_CODE==0x8078 || "
...
TLPM_STATBIT_OPER_CAL = (
    0x0001  # < The instrument is currently performing a calibration.
)
...
TLPM_STATBIT_OPER_TRIG = (
    0x0020  # < The instrument is in a �wait for trigger� state of the trigger model.
)
TLPM_STATBIT_OPER_ARM = (
    0x0040  # < The instrument is in a �wait for arm� state of the trigger model.
)
TLPM_STATBIT_OPER_CORR = (
    0x0080  # < The instrument is currently performing a correction (Auto-PID tune).
)
...
TLPM_STATBIT_OPER_INST = (
    0x2000  # < One of n multiple logical instruments is reporting OPERational status.
)
TLPM_STATBIT_OPER_PROG = (
    0x4000  # < A user-defined programming is currently in the run state.
)
...
SENSOR_TYPE_NONE = (
    0x0  # No sensor. This value is used to mark sensor data for 'no sensor connected'.
)
SENSOR_TYPE_PD_SINGLE = (
    0x1  # Single photodiode sensor. Only one ipd input active at the same time.
)
...
SENSOR_SUBTYPE_PD_SINGLE_STD = (
    0x02  # Standard single photodiode sensor (no temperature sensor)
)
...
SENSOR_SUBTYPE_PD_SINGLE_STD_T = (
    0x12  # Standard single photodiode sensor (with temperature sensor)
)
...
SENSOR_SUBTYPE_THERMO_STD_T = (
    0x12  # Standard thermopile sensor (with temperature sensor)
)
...
SENSOR_SUBTYPE_PYRO_STD_T = (
    0x12  # Standard pyroelectric sensor (with temperature sensor)
)
...
class TLPM:
    def __init__(self):
        if sizeof(c_voidp) == 4:
            ...
            self.dll = cdll.LoadLibrary(
                r"C:\Users\Romane\Documents\Workspace\polarization-analysis\ThorLabsDriver\Bin\TLPM_32.dll"
            )
        else:
            # Load .dll lib for 64 bit
            self.dll = cdll.LoadLibrary(
                r"C:\Users\Romane\Documents\Workspace\polarization-analysis\ThorLabsDriver\Bin\TLPM_64.dll"
            )
    ...
    def open(self, resourceName, IDQuery, resetDevice):
        ...
        pInvokeResult = self.dll.TLPM_init(
            resourceName, IDQuery, resetDevice, byref(self.devSession)
        )
    ...
    def getRsrcInfo(
        self, index, modelName, serialNumber, manufacturer, deviceAvailable
    ):
        """
    ...
    def setTime(self, year, month, day, hour, minute, second):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_setTime(
            self.devSession, year, month, day, hour, minute, second
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getTime(self, year, month, day, hour, minute, second):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getTime(
            self.devSession, year, month, day, hour, minute, second
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def setInputFilterState(self, inputFilterState):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_setInputFilterState(
            self.devSession, inputFilterState
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getInputFilterState(self, inputFilterState):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getInputFilterState(
            self.devSession, inputFilterState
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getAttenuation(self, attribute, attenuation):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getAttenuation(
            self.devSession, attribute, attenuation
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getBeamDia(self, attribute, beamDiameter):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getBeamDia(
            self.devSession, attribute, beamDiameter
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def setPhotodiodeResponsivity(self, response):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_setPhotodiodeResponsivity(
            self.devSession, response
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getPhotodiodeResponsivity(self, attribute, responsivity):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getPhotodiodeResponsivity(
            self.devSession, attribute, responsivity
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def setThermopileResponsivity(self, response):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_setThermopileResponsivity(
            self.devSession, response
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getThermopileResponsivity(self, attribute, responsivity):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getThermopileResponsivity(
            self.devSession, attribute, responsivity
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def setPyrosensorResponsivity(self, response):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_setPyrosensorResponsivity(
            self.devSession, response
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getPyrosensorResponsivity(self, attribute, responsivity):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getPyrosensorResponsivity(
            self.devSession, attribute, responsivity
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def setCurrentAutoRange(self, currentAutorangeMode):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_setCurrentAutoRange(
            self.devSession, currentAutorangeMode
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getCurrentAutorange(self, currentAutorangeMode):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getCurrentAutorange(
            self.devSession, currentAutorangeMode
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def setCurrentRange(self, current_to_Measure):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_setCurrentRange(
            self.devSession, current_to_Measure
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getCurrentRange(self, attribute, currentValue):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getCurrentRange(
            self.devSession, attribute, currentValue
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getCurrentRanges(self, currentValues, rangeCount):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getCurrentRanges(
            self.devSession, currentValues, rangeCount
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def setCurrentRef(self, currentReferenceValue):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_setCurrentRef(
            self.devSession, currentReferenceValue
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getCurrentRef(self, attribute, currentReferenceValue):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getCurrentRef(
            self.devSession, attribute, currentReferenceValue
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def setCurrentRefState(self, currentReferenceState):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_setCurrentRefState(
            self.devSession, currentReferenceState
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getCurrentRefState(self, currentReferenceState):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getCurrentRefState(
            self.devSession, currentReferenceState
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getEnergyRange(self, attribute, energyValue):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getEnergyRange(
            self.devSession, attribute, energyValue
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def setEnergyRef(self, energyReferenceValue):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_setEnergyRef(
            self.devSession, energyReferenceValue
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getEnergyRef(self, attribute, energyReferenceValue):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getEnergyRef(
            self.devSession, attribute, energyReferenceValue
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def setEnergyRefState(self, energyReferenceState):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_setEnergyRefState(
            self.devSession, energyReferenceState
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getEnergyRefState(self, energyReferenceState):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getEnergyRefState(
            self.devSession, energyReferenceState
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getFreqRange(self, lowerFrequency, upperFrequency):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getFreqRange(
            self.devSession, lowerFrequency, upperFrequency
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def setPowerAutoRange(self, powerAutorangeMode):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_setPowerAutoRange(
            self.devSession, powerAutorangeMode
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getPowerAutorange(self, powerAutorangeMode):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getPowerAutorange(
            self.devSession, powerAutorangeMode
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getPowerRange(self, attribute, powerValue):
        ...
        pInvokeResult = self.dll.TLPM_getPowerRange(
            self.devSession, attribute, powerValue
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getPowerRef(self, attribute, powerReferenceValue):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getPowerRef(
            self.devSession, attribute, powerReferenceValue
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def setPowerRefState(self, powerReferenceState):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_setPowerRefState(
            self.devSession, powerReferenceState
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getPowerRefState(self, powerReferenceState):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getPowerRefState(
            self.devSession, powerReferenceState
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getPowerCalibrationPointsInformation(
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getPowerCalibrationPointsInformation(
            self.devSession,
            index,
            serialNumber,
            calibrationDate,
    ...
    def getPowerCalibrationPointsState(self, index, state):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getPowerCalibrationPointsState(
            self.devSession, index, state
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def setPowerCalibrationPointsState(self, index, state):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_setPowerCalibrationPointsState(
            self.devSession, index, state
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult

    def getPowerCalibrationPoints(
        self, index, pointCounts, wavelengths, powerCorrectionFactors
    ):
        """
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getPowerCalibrationPoints(
            self.devSession, index, pointCounts, wavelengths, powerCorrectionFactors
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def setPowerCalibrationPoints(
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_setPowerCalibrationPoints(
            self.devSession,
            index,
            pointCounts,
            wavelengths,
    ...
    def setVoltageAutoRange(self, voltageAutorangeMode):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_setVoltageAutoRange(
            self.devSession, voltageAutorangeMode
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getVoltageAutorange(self, voltageAutorangeMode):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getVoltageAutorange(
            self.devSession, voltageAutorangeMode
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def setVoltageRange(self, voltage_to_Measure):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_setVoltageRange(
            self.devSession, voltage_to_Measure
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getVoltageRange(self, attribute, voltageValue):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getVoltageRange(
            self.devSession, attribute, voltageValue
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getVoltageRanges(self, voltageValues, rangeCount):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getVoltageRanges(
            self.devSession, voltageValues, rangeCount
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def setVoltageRef(self, voltageReferenceValue):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_setVoltageRef(
            self.devSession, voltageReferenceValue
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getVoltageRef(self, attribute, voltageReferenceValue):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getVoltageRef(
            self.devSession, attribute, voltageReferenceValue
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def setVoltageRefState(self, voltageReferenceState):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_setVoltageRefState(
            self.devSession, voltageReferenceState
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getVoltageRefState(self, voltageReferenceState):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getVoltageRefState(
            self.devSession, voltageReferenceState
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getPeakThreshold(self, attribute, peakThreshold):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getPeakThreshold(
            self.devSession, attribute, peakThreshold
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def setExtNtcParameter(self, r0Coefficient, betaCoefficient):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_setExtNtcParameter(
            self.devSession, r0Coefficient, betaCoefficient
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getExtNtcParameter(self, attribute, r0Coefficient, betaCoefficient):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getExtNtcParameter(
            self.devSession, attribute, r0Coefficient, betaCoefficient
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def setFilterAutoMode(self, filterAutoPositionDetection):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_setFilterAutoMode(
            self.devSession, filterAutoPositionDetection
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getFilterAutoMode(self, filterAutoPositionDetection):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getFilterAutoMode(
            self.devSession, filterAutoPositionDetection
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getAnalogOutputSlopeRange(self, minSlope, maxSlope):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getAnalogOutputSlopeRange(
            self.devSession, minSlope, maxSlope
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getAnalogOutputSlope(self, attribute, slope):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getAnalogOutputSlope(
            self.devSession, attribute, slope
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getAnalogOutputVoltageRange(self, minVoltage, maxVoltage):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getAnalogOutputVoltageRange(
            self.devSession, minVoltage, maxVoltage
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getAnalogOutputVoltage(self, attribute, voltage):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getAnalogOutputVoltage(
            self.devSession, attribute, voltage
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getPositionAnalogOutputSlopeRange(self, minSlope, maxSlope):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getPositionAnalogOutputSlopeRange(
            self.devSession, minSlope, maxSlope
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def setPositionAnalogOutputSlope(self, slope):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_setPositionAnalogOutputSlope(
            self.devSession, slope
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getPositionAnalogOutputSlope(self, attribute, slope):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getPositionAnalogOutputSlope(
            self.devSession, attribute, slope
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getPositionAnalogOutputVoltageRange(self, minVoltage, maxVoltage):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getPositionAnalogOutputVoltageRange(
            self.devSession, minVoltage, maxVoltage
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getPositionAnalogOutputVoltage(self, attribute, voltageX, voltageY):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getPositionAnalogOutputVoltage(
            self.devSession, attribute, voltageX, voltageY
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def setNegativePulseWidth(self, pulseDuration):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_setNegativePulseWidth(
            self.devSession, pulseDuration
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def setPositivePulseWidth(self, pulseDuration):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_setPositivePulseWidth(
            self.devSession, pulseDuration
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def measExtNtcTemperature(self, temperature):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_measExtNtcTemperature(
            self.devSession, temperature
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def meas4QPositions(self, xPosition, yPosition):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_meas4QPositions(
            self.devSession, xPosition, yPosition
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def meas4QVoltages(self, voltage1, voltage2, voltage3, voltage4):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_meas4QVoltages(
            self.devSession, voltage1, voltage2, voltage3, voltage4
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def measNegPulseWidth(self, negativePulseWidth):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_measNegPulseWidth(
            self.devSession, negativePulseWidth
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def measPosPulseWidth(self, positivePulseWidth):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_measPosPulseWidth(
            self.devSession, positivePulseWidth
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def measNegDutyCycle(self, negativeDutyCycle):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_measNegDutyCycle(
            self.devSession, negativeDutyCycle
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def measPosDutyCycle(self, positiveDutyCycle):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_measPosDutyCycle(
            self.devSession, positiveDutyCycle
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getNextFastArrayMeasurement(self, count, timestamps, values):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getNextFastArrayMeasurement(
            self.devSession, count, timestamps, values
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def confPowerMeasurementSequence(self, baseTime):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_confPowerMeasurementSequence(
            self.devSession, baseTime
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def confPowerMeasurementSequenceHWTrigger(self, baseTime, hPos):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_confPowerMeasurementSequenceHWTrigger(
            self.devSession, baseTime, hPos
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def confCurrentMeasurementSequence(self, baseTime):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_confCurrentMeasurementSequence(
            self.devSession, baseTime
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def confCurrentMeasurementSequenceHWTrigger(self, baseTime, hPos):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_confCurrentMeasurementSequenceHWTrigger(
            self.devSession, baseTime, hPos
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def startMeasurementSequence(self, autoTriggerDelay, triggerForced):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_startMeasurementSequence(
            self.devSession, autoTriggerDelay, triggerForced
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getMeasurementSequence(self, baseTime, timeStamps, values):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getMeasurementSequence(
            self.devSession, baseTime, timeStamps, values
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getMeasurementSequenceHWTrigger(self, baseTime, timeStamps, values):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getMeasurementSequenceHWTrigger(
            self.devSession, baseTime, timeStamps, values
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def setDigIoDirection(self, IO0, IO1, IO2, IO3):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_setDigIoDirection(
            self.devSession, IO0, IO1, IO2, IO3
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getDigIoDirection(self, IO0, IO1, IO2, IO3):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getDigIoDirection(
            self.devSession, IO0, IO1, IO2, IO3
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def setDigIoOutput(self, IO0, IO1, IO2, IO3):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_setDigIoOutput(
            self.devSession, IO0, IO1, IO2, IO3
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getDigIoOutput(self, IO0, IO1, IO2, IO3):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getDigIoOutput(
            self.devSession, IO0, IO1, IO2, IO3
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def setDigIoPinMode(self, pinNumber, pinMode):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_setDigIoPinMode(
            self.devSession, pinNumber, pinMode
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getDigIoPinMode(self, pinNumber, pinMode):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getDigIoPinMode(
            self.devSession, pinNumber, pinMode
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def getDigIoPinInput(self, IO0, IO1, IO2, IO3):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_getDigIoPinInput(
            self.devSession, IO0, IO1, IO2, IO3
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def errorQuery(self, errorNumber, errorMessage):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_errorQuery(
            self.devSession, errorNumber, errorMessage
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
    ...
    def identificationQuery(
        self, manufacturerName, deviceName, serialNumber, firmwareRevision
    ):
        """
    ...
    def readRaw(self, buffer, size, returnCount):
        ...
        Returns:
            int: The return value, 0 is for success
        """
        pInvokeResult = self.dll.TLPM_readRaw(
            self.devSession, buffer, size, returnCount
        )
        self.__testForError(pInvokeResult)
        return pInvokeResult
